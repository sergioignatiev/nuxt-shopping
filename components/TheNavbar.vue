...
<div class="flex items-center gap-4">
  <NuxtLink v-for="n in navigation" :key="n.id" class="text-slate-500" :to="n.link">{{ n.label }}</NuxtLink>
</div>

<div class="relative">
  <div class="flex items-center">
    <svg class="absolute px-1"  xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="#171616" d="M10.77 18.3a7.53 7.53 0 1 1 7.53-7.53a7.53 7.53 0 0 1-7.53 7.53m0-13.55a6 6 0 1 0 6 6a6 6 0 0 0-6-6"/><path fill="#171616" d="M20 20.75a.74.74 0 0 1-.53-.22l-4.13-4.13a.75.75 0 0 1 1.06-1.06l4.13 4.13a.75.75 0 0 1 0 1.06a.74.74 0 0 1-.53.22"/></svg>
    <div v-if="search" class="focus:outline-none absolute right-0 m-1  text-[10px] p-1 bg-main text-white rounded-md cursor-pointer outline-none"  @click="search=''" >Очистить</div>
<input  v-model="search" class="focus:outline-none flex items-center w-[400px] h-[38px] rounded-md p-1 px-[1.5em] shadow-inner shadow-slate-300  bg-slate-100" type="text"  placeholder="Искать Товар...">
</div>
<MenuSearchBox
