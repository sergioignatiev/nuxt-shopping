...
<input  class="focus:outline-none flex items-center w-[400px] h-[38px] rounded-md p-1 px-[1.5em] shadow-inner shadow-slate-300  bg-slate-100" type="text" placeholder="Искать Товар..."  v-model="search">
</div>
<MenuSearchBox
