<template>
  ...
  <select name="city" id="city">
    ...
    <button class=" hover:opacity-90 rounded-md px-4 py-3 text-[20px] font-bold shadow-md text-white bg-main" v-show="product.bascet===false" @click="addToTheBascet">Добавить</button>
